...
const snack1 = publicAsset("snack1.jpg");
const snack2 = publicAsset("snack2.jpg");
const snack3 = publicAsset("snack3.jpg");
const snack4 = publicAsset("snack4.jpg");
const snack5 = publicAsset("snack5.jpg");
const snack6 = publicAsset("snack6.jpg");
...
const getTabFromHash = (hash) => {
  ...
  return TAB_ALIASES[route] ?? "home";
};

const getHashForTab = (tab) => TAB_HASHES[tab] ?? TAB_HASHES.home;
  ...
  return (
    <div className="min-h-screen bg-[#fff7fb] font-nunito text-[#211620]">
      ...
      <main className="relative w-full overflow-x-hidden">
        {currentTab === "home" && <HomeView onNavigate={navigateTo} />}
